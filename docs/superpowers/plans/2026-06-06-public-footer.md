# Public Page Footer Redesign Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Replace the current public footer in `public-layout.tsx` with a modern, responsive navy gradient footer inspired by RisetMu.

**Architecture:** Modify `public-layout.tsx` by replacing the simple copyright footer with a structured grid-based footer containing brand details, contact info, menu links, external links, and the Muhammadiyah card, styled with Tailwind CSS.

**Tech Stack:** React (TypeScript + Inertia.js), Tailwind CSS, Lucide Icons.

---

### Task 1: Public Layout Footer Implementation

**Files:**
- Modify: `resources/js/layouts/public-layout.tsx`

- [ ] **Step 1: Replace footer section in public-layout.tsx**
  Edit `resources/js/layouts/public-layout.tsx`. Replace the current `<footer>` block and import Lucide icons:
  ```tsx
  import logoUrl from '@/assets/logo_dark.png';
  import { Button } from '@/components/ui/button';
  import { type SharedData } from '@/types';
  import { Link, usePage } from '@inertiajs/react';
  import { LayoutDashboard, MapPin, Phone, Printer, Mail, Facebook, Twitter, Youtube, MessageSquare } from 'lucide-react';
...
- [ ] **Step 2: Verify compiling**
  Run: `npm run build` or types compilation checks.
