...
export default function JournalShow({ journal, articles, statistics, harvestLogs = [], isHarvestPending, importLogs = [] }: Props) {
                ...
                <Card className="mb-0 overflow-hidden border-sidebar-border/70 shadow-sm dark:border-sidebar-border">
                    ...
                    <CardContent className="p-6">
                        <EditOaiUrlDialog
                            ...
                            initialUrls={journal.oai_urls}
                            updateRoute="user.journals.update-oai-urls"
                        />
                        <ImportXmlDialog
                            open={showImportXmlModal}
                            onOpenChange={setShowImportXmlModal}
                            journalId={journal.id}
                            uploadRoute="user.journals.import-xml"
                        />
