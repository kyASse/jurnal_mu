...
interface Props {
    ...
    universityUsers: Array<{ id: number; name: string; email: string }>;
}

export default function JournalsEdit({ journal, scientificFields, sintaRankOptions, indexationOptions, universityUsers }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Journals', href: route('admin.journals.index') },
        { title: journal.title, href: route('admin.journals.show', journal.id) },
        { title: 'Edit', href: route('admin.journals.edit', journal.id) },
    ];
            ...
            <div className="py-6">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <JournalForm
                            submitUrl={route('admin.journals.update', journal.id)}
                            cancelUrl={route('admin.journals.show', journal.id)}
