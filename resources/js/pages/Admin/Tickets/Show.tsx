...
import { ArrowLeft, MessageSquare, Paperclip, RefreshCcw, Send } from 'lucide-react';
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">Manage ticket and respond to user.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <Card className="flex h-full flex-1 flex-col">
                            <CardHeader className="border-b px-4 py-3">
                                <CardTitle className="flex items-center text-base">
                                    <MessageSquare className="mr-2 h-4 w-4" /> Conversation history
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="flex flex-1 flex-col p-0">
                                <ScrollArea className="max-h-[500px] min-h-[300px] flex-1 p-4">
                                ...
                                <div className="border-t bg-muted/30 p-4">
                                    <form onSubmit={submitReply} className="flex flex-col gap-3">
                                        ...
                                        {replyErrors.attachment && <div className="mt-1 text-xs text-red-500">{replyErrors.attachment}</div>}
                                    </form>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className="flex flex-col gap-4 lg:col-span-1">
                            ...
                            <CardContent>
                                <form onSubmit={submitStatusUpdate} className="flex flex-col gap-4">
                                    ...
                                    <Button
                                        ...
                                        variant="secondary"
                                        className="w-full"
                                        disabled={updatingStatus || statusData.status === ticket.status}
                                    >
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4 text-sm">
                                ...
                                <hr />
                                <div>
                                    <span className="mb-1 block text-muted-foreground">Ticket Status</span>
