...
export default function JournalShow({ journal, articles, articlesCount, harvestLogs = [], isHarvestPending, importLogs = [] }: Props) {
                    ...
                    <Card className="mb-8 overflow-hidden border-sidebar-border/70 shadow-sm dark:border-sidebar-border">
                        ...
                        <CardContent className="p-6">
                            ...
                            <ImportXmlDialog
                                ...
                                journalId={journal.id}
                                uploadRoute="admin-kampus.journals.import-xml"
                            />
