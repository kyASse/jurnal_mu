...
export default function JournalsIndex({ journals, filters, scientificFields, sintaRanks, statusOptions }: Props) {
    ...
    const hasActiveFilters = search || statusFilter || sintaRankFilter || scientificFieldFilter;
