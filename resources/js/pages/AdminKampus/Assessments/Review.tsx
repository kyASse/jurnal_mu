...
import type { BreadcrumbItem, JournalAssessment, AssessmentResponse, AssessmentAttachment } from '@/types';
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Review and approve or request revision for this assessment
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-start justify-between">
                            ...
                            <Badge variant="secondary" className="bg-yellow-500 text-white">Submitted</Badge>
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                <span className="font-medium">Scientific Field:</span>{' '}
                                {assessment.journal.scientific_field?.name || 'N/A'}
                            </div>
                            <div>
                        ...
                        {assessment.responses && assessment.responses.length > 0 ? (
                            <div className="space-y-6">
                                {assessment.responses.map((response: AssessmentResponse, index: number) => {
                                    ...
                                    return (
                                        <div key={response.id} className="border-l-4 border-primary pl-4 py-3">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Approve the assessment or request revision with feedback
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground text-center">
                            <strong>Approve:</strong> Mark as reviewed and complete.{' '}
                            <strong>Request Revision:</strong> Send back to draft status with your notes.
                        </p>
                    </CardContent>
                </Card>
            </div>
