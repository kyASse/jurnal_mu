                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border bg-white dark:bg-neutral-950 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{stats.total_journals}</h3>
                            </div>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border bg-white dark:bg-neutral-950 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{stats.total_assessments}</h3>
                            </div>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border bg-white dark:bg-neutral-950 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold mt-2">{stats.average_score.toFixed(1)}</h3>
                            </div>
