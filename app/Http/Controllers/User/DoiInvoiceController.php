...
{
    /**
     * Display a listing of invoices for the current user or user's university.
     */
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('User/Doi/Invoices/Index', [
            'invoices' => $invoices,
    ...
    public function show(Request $request, DoiInvoice $invoice): Response
    {
        ...
        return Inertia::render('User/Doi/Invoices/Show', [
            'invoice' => [
                'id' => $invoice->id,
                'invoice_number' => $invoice->invoice_number,
                'subtotal' => (float) $invoice->subtotal,
