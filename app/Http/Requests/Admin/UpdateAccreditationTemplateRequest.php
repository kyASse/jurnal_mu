...
class UpdateAccreditationTemplateRequest extends FormRequest
{
    /**
    ...
    {
        $templateId = $this->route('template'); // Route parameter
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('accreditation_templates', 'name')->ignore($templateId),
            ],
